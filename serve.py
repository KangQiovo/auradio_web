...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        ...
        parts=path[len(LEGACY_PREFIX) if path.startswith(LEGACY_PREFIX) else len(PREFIX):].split('/')
